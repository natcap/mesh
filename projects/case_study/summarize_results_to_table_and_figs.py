...
def create_scenario_calorie_csv(input_dir, output_uri):
    ...
    for scenario in scenarios:
        ...
        print('carbon_result_uri', carbon_result_uri)
...
do_create_percent_difference_from_baseline_bar_chart = 0
...
do_create_percent_difference_from_bau_bar_chart = 0
...
if do_minor_alignment_nudge:
    # uris = [i for i in nd.get_list_of_file_uris_recursively(input_dir, filter_extensions='.tif')]
    # print(uris)
