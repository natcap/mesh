...
from pygeoprocessing_vmesh import geoprocessing_core
from pygeoprocessing_vmesh import calculate_disjoint_polygon_set as pgp_calculate_disjoint_polygon_set
