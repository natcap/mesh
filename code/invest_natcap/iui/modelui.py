...
class ModelUI(base_widgets.ExecRoot):
    def __init__(self, uri, main_window, last_run_override=None, args=None):
        ...
        #Custom code: added last_run_override
        ...
        base_widgets.ExecRoot.__init__(self, uri, last_run_override, layout, registrar, main_window)
...
def main(uri, use_gui=True, last_run_override=None, args=None):
    ...
    window = base_widgets.MainWindow(ModelUI, uri, last_run_override, args)
    if use_gui == True:
        window.show()
        result = app.exec_()
    else:
