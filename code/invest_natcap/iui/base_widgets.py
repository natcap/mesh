...
class MainWindow(QtGui.QMainWindow):
    def __init__(self, root_class, uri, last_run_override=None, args=None):
        QtGui.QMainWindow.__init__(self)
        self.ui = root_class(uri, self, last_run_override, args)
...
class ExecRoot(Root):
    def __init__(self, uri, last_run_override=None, layout=None, object_registrar=None,
        ...
        if last_run_override:
            self.lastRun = last_run_override
