...
def create_hubs_raster(hubs_shape_uri, decay, aoi_raster_uri, hubs_out_uri):
    ...
    nodata = pygeoprocessing_vmesh.geoprocessing.get_nodata_from_uri(aoi_raster_uri)
    ...
    cell_size = pygeoprocessing_vmesh.geoprocessing.get_cell_size_from_uri(aoi_raster_uri)
...
def create_unweighted_raster(output_dir, aoi_raster_uri, raster_files_uri):
    ...
    aoi_pixel_size = pygeoprocessing_vmesh.geoprocessing.get_cell_size_from_uri(aoi_raster_uri)
    aoi_nodata = pygeoprocessing_vmesh.geoprocessing.get_nodata_from_uri(aoi_raster_uri)
...
def create_weighted_raster(
    ...
    aoi_nodata = pygeoprocessing_vmesh.geoprocessing.get_nodata_from_uri(aoi_raster_uri)
    pixel_size_out = pygeoprocessing_vmesh.geoprocessing.get_cell_size_from_uri(aoi_raster_uri)
