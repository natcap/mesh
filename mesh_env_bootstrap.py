...
def install_wheel(project_names, py_executable, search_dirs=None):
    ...
    pip_deps = "html5lib six colorama requests wheel".split()
    wheels = find_wheels(['setuptools', 'pip'] + pip_deps, search_dirs)
...
def after_install(options, home_dir):
    ...
    try:
        subprocess.call(
            ...
            + []
            + ['paver==1.2.4+natcap.1', 'distribute', 'gdal', 'matplotlib>=1.2.0', 'markdown', 'xlrd', 'git+https://github.com/pyinstaller/pyinstaller.git@3.0', 'git+https://github.com/phargogh/paver@natcap-version', 'hg+https://bitbucket.org/jdouglass/versioner@0.2.4#egg=natcap.versioner']
        )
    except OSError:
        subprocess.call(
